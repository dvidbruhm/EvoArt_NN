...
class Net(nn.Module):
    def __init__(self, depth, nb_neurons_per_layer):
        ...
        self.whole_net = nn.Sequential(nn.Linear(settings.nb_input_params + 1, nb_neurons_per_layer))
        ...
        self.whole_net.add_module("output_layer", nn.Linear(nb_neurons_per_layer, settings.channels))
